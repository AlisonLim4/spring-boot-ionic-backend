...
import com.alisonlima.cursomc.domain.ItemPedido;
import com.alisonlima.cursomc.domain.Pagamento;
import com.alisonlima.cursomc.domain.PagamentoComBoleto;
import com.alisonlima.cursomc.domain.PagamentoComCartao;
import com.alisonlima.cursomc.domain.Pedido;
import com.alisonlima.cursomc.domain.Produto;
import com.alisonlima.cursomc.domain.enums.EstadoPagamento;
import com.alisonlima.cursomc.domain.enums.TipoCliente;
import com.alisonlima.cursomc.repositories.CategoriaRepository;
import com.alisonlima.cursomc.repositories.CidadeRepository;
...
import com.alisonlima.cursomc.repositories.EstadoRepository;
import com.alisonlima.cursomc.repositories.ItemPedidoRepository;
import com.alisonlima.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		// salvando as categorias e produtos no Banco
		...
		// Salvando Estados e cidades no Banco
		estadoRepository.saveAll(Arrays.asList(est1, est2));
		cidadeRepository.saveAll(Arrays.asList(c1, c2, c3));

		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27373323", "93838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Aveninda Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);

		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));

		// Salvando Clientes e endereços
